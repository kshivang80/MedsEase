...
import { CategoriesSlider6Link, ChooseLink, CustomerLink, DealsSlider11Link, Discover, FeaturedLink, FrequentlyLink, HealthArticlesLink, LaunchesSlider7Link, OfferSlider4Link, OnlyImg2Link, OnlyImgLink, PaymentSlider5Link, ShopConcernLink, Slider2Link, Slider3Link, SpotlightSlider11Link, TrendingSlider8Link, WellnessSlider11Link } from './HomeCards';
import { settings, settings10, settings11, settings12, settings2, settings3, settings4, settings5, settings6, settings7, settings8, settings9 } from './ResponsiveCard';
    ...
    <div className="Maindiv">
      ...
      <div className='Slide3'>
        ...
        <div className='LiveTest' >
          <div style={{ fontSize: "26px", color: "#30363C", width: "95%", fontWeight: "bolder", }}>
            <p>Lab Tests by Health Concern</p>
          </div>
          <div style={{ display: "flex", height: "60%", width: "95%", justifyItems: "self-start", }} >
            <div>
      ...
      <div className='Slide4'>
        <div className='LiveTest'>
          <p style={{ fontSize: "26px", color: "#30363C", width: "auto",  fontWeight: "bolder", }}>Previously Browsed Items</p>


        </div>
        <div className='Data-prev'>
          <div className='oneDiv'>
            <div className='imgBox' style={{ width: "70%", height: "180px", margin: "auto",  }}>
            ...
            <div style={{ width: "70%", margin: "auto",  overflow: "hidden" }} >
              <Text noOfLines={[1, 2, 2]} style={{ fontSize: "18px", fontFamily: "system-ui", color: "#30363C", }}>Calcimax Forte Plus Strip Of 30 Tablets </Text>
          ...
          <div className='oneDiv'>
            ...
            <div style={{ width: "70%", margin: "auto", overflow: "hidden" }} >
              <Text  noOfLines={[1, 2, 2]} style={{ fontSize: "18px", fontFamily: "system-ui", color: "#30363C", }}>Ecosprin 75mg Strip Of 14 Tablets </Text>
      ...
      <div className='justOffer'>
        <div className='LiveTest1'>
          <p style={{ fontSize: "26px", color: "#30363C", width: "auto",  fontWeight: "bolder",marginTop:"40px"}}>Offers Just for You</p>
      ...
      <div className='Payment'>
        <div className='LiveTest1'>
          <p style={{ fontSize: "26px", color: "#30363C", width: "auto",  fontWeight: "bolder", padding: "-40px 0px -40px 10px" }}>Payment Offers</p>
      ...
      <div className='Launches'>
        <div className='LiveTest1'>
          <p style={{ fontSize: "26px", color: "#30363C", width: "auto",  fontWeight: "bolder", }}>New Launches</p>
          <p style={{ fontSize: "18px", color: "#4F585E", width: "auto",  fontWeight: "600", }}>New wellness range just for you!</p>
      ...
      <div className='Launches'>
        <div className='LiveTest1'>
          <p style={{ fontSize: "26px", color: "#30363C", width: "auto",  fontWeight: "bolder", }}>Trending Near You</p>
          <p style={{ fontSize: "18px", color: "#4F585E", width: "auto",  fontWeight: "600", }}>Popular in your city</p>
      ...
      <Box className='ShopConcern' >
        ...
        <Box className='LiveTest1' marginTop="50px">
          ...
          <p style={{ fontSize: "26px", color: "#30363C", width: "auto",  fontWeight: "bolder", }}>Shop by Concern</p>
          <p style={{ fontSize: "18px", color: "#4F585E", width: "auto",  fontWeight: "600", }}>Products are handpicked by experts</p>
      ...
      <Box className='Frequently'>
        ...
        <Box className='LiveTest1' marginTop="50px" >
          ...
          <p style={{ fontSize: "26px", color: "#30363C", width: "auto",  fontWeight: "bolder", }}>Frequently Booked Lab Tests</p>
          ...
          <SimpleGrid columns={{ base: 2, sm: 2, md: 4, lg: 4, }} spacing={10} h="auto" w="100%" marginTop="20px" box-shadow=" rgba(0, 0, 0, 0.24) 0px 3px 8px">
            {FrequentlyLink.map((item) => (
              ...
              <Box className='Frequently-card' w="100%" h="300px" bg="#E8F7FD" borderRadius="15px" box-shadow=" rgba(0, 0, 0, 0.24) 0px 3px 8px" >
      ...
      <Box className='Wellness'>
        <Box className='LiveTest2-wellness'>
          <p style={{ fontSize: "26px", color: "#30363C", width: "auto", fontWeight: "bolder", }}>Wellness Essentials of the Week</p>
          <p style={{ fontSize: "18px", color: "#4F585E", width: "auto", fontWeight: "600", }}>Super charge your immunity with us</p>
              ...
              <div className="Wellness1-card" >
                ...
                <Box style={{ display: "flex", width: "100%", height: "100%" }}>
                  ...
                  <Box className="Wellness-bottom" >
                    <Box marginTop="30px">
                      <Text as="b"  noOfLines={[1, 2,]}>{item.name}</Text>
      ...
      <Box className='Wellness'>
        <Box className='LiveTest2-wellness'>
          <p style={{ fontSize: "26px", color: "#30363C", width: "auto", fontWeight: "bolder", }}>Featured Brands</p>
          <p style={{ fontSize: "18px", color: "#4F585E", width: "auto", fontWeight: "600", }}>Pick from our favourite brands</p>
      ...
      <div className='Deals' style={{ marginTop: "60px" }} >
        <div className='LiveTest1'  >
          <p style={{ fontSize: "26px", color: "#30363C", width: "auto", fontWeight: "bolder", }}>Deals of the Day</p>
          <p style={{ fontSize: "18px", color: "#4F585E", width: "auto", fontWeight: "600", }}>09:15 MINS LEFT, HURRY!</p>
      ...
      <div className='Trending' style={{ marginTop: "40px" }}>
        <div className='LiveTest1'>
          <p style={{ fontSize: "26px", color: "#30363C", width: "auto",  fontWeight: "bolder", }}>In the Spotlight</p>
      ...
      <Box className='Health'>
        <Box className='LiveTest2-wellness'>
          <p style={{ fontSize: "26px", color: "#30363C", width: "auto", fontWeight: "bolder", }}>Health Articles</p>
          <p style={{ fontSize: "18px", color: "#4F585E", width: "auto", fontWeight: "600", }}>Get up-to-date on our latest health updates</p>
            ...
            {HealthArticlesLink.map((item) => (
              <div className="Health-card">
                ...
                <div className="Healthbottom">
                  <Text noOfLines={[1, 3]} marginTop="10px" fontSize='lg'>{item.name}</Text>
      ...
      <Box className='Choose'>
        <Box className='LiveTest2-wellness'>
          <p style={{ fontSize: "26px", color: "#30363C", width: "auto",  fontWeight: "bolder", }}>Choose Essentials of the Week</p>
              ...
              <div className="Choose1-card" >
                ...
                <Box style={{ display: "flex", width: "100%", height: "100%", }}>
                  ...
                  <Box className="Choose-bottom" >
                    <Box marginTop="20px">
                      <Text fontSize='2xl' as="b"  noOfLines={[1, 2,]}>{item.name}</Text>

                    </Box>


                    <Text noOfLines={[1, 2, 2]} fontSize='lg' fontFamily="sans-serif" >{item.des}</Text>
      ...
      <Box className='CustomersTopMain'>
        <Box className='LiveTest2-wellness'>
          <p style={{ fontSize: "26px", color: "#30363C", width: "auto",  fontWeight: "bolder", }}> What Our Customers have to Say</p>
            ...
            {CustomerLink.map((item) => (
              <div className="Customers">
                ...
                <div className="Customerstop">
                  <Text marginLeft="15px" fontSize='lg' as='b' color="#30363C">{item.name}</Text>
                  <Text marginLeft="15px" fontSize='lg' color="#4F585E">{item.date}</Text>
                </div>
                <div className="Customersbottom">
                 
                  <Text marginLeft="8px" fontSize='xl' noOfLines={[1, 8, 8]} color="#4F585E">{item.des}</Text>
                </div>
      ...
      <Box w="95%" margin="auto"  border="1px solid white">
        <Box  marginTop="60px" >
        <Text fontSize='lg'>Top-Selling Healthcare Products: Accu-Chek Active - 100 Strips | Supradyn Multivitamin Tablets | DR Morepen BG 03 - 50 Strips | Dettol Antiseptic Liquid | Ensure Diabetes Care Vanilla Sugar Free Jar | Dettol Instant Hand Sanitizer | Everherb Shilajit | Softovac SF Powder | Pediasure Premium Chocolate Refill</Text>

        </Box>
        <Box   marginTop="30px"   >
          <Text  fontSize='lg'>Top-Selling Medicines: Dolovera Gel | Neurobion Forte | Chymoral Forte | Crocin Advance | Soframycin | Dexorange | Becadexamin | Folvite | Livogen | Becosules | Fourderm | Nurokind Plus | Burnol | Crocin 650 | Mintop 5 | Thrombophob | Evion 600</Text>
        </Box>

        <Box   marginTop="30px"   >
          <Text  fontSize='lg'>COVID-19 Preventatives: N95 Masks | Hand Sanitizers | Hand Gloves, Disinfectants, Thermometers & more!</Text>
        </Box>

        <Box  marginTop="30px"   >
          <Text as='b' fontSize='lg' color="balck">Your One-Stop Online Pharmacy - PharmEasy</Text>
        </Box>

        <Box  marginTop="30px"   >
          <Box>
             <Text as='b'  fontSize='md' color="balck">We've got India Covered!</Text>
          </Box>
          <br/>
          <Box>
            <Text fontSize='md' color="balck">We now deliver in 1000+ cities and towns across 22000+ pin codes. We thereby cover every nook and corner of the country! The major cities in which we deliver include Mumbai, Kolkata, Delhi, Bengaluru, Ahmedabad, Hyderabad, Chennai, Thane, Howrah, Pune, Gurgaon, Navi Mumbai, Jaipur, Noida, Lucknow, Ghaziabad & Vadodara.</Text>
          </Box>
        ...
        <Box  marginTop="30px"   >
          <Box>
             <Text as='b'  fontSize='md' color="balck">Why Are We The Most Preferred Online Pharmacy?</Text>
          </Box>
          <br/>
          <Box>
            <Text fontSize='md' color="balck">Lucrative offers on our platform allow you to make payment online and via various payment wallets at a discounted price. Alternatively, you can also choose to pay cash on delivery as we deliver the products at your doorstep. We cater to all your pharmaceutical needs and also make ordering medicines online a hassle-free experience for you. We connect you only with registered retail pharmacies & certified diagnostic labs. We ensure that healthcare is affordable to all and make the process of ordering online simple.</Text>
          </Box>
        ...
        <Box  marginTop="30px"   >
          <Box>
             <Text as='b'  fontSize='md' color="balck">Access medical and health information:</Text>
          </Box>
          <br/>
          <Box>
        ...
        <Box  marginTop="30px"   >
          <Box>
             <Text as='b'  fontSize='md' color="balck">We Believe in ‘Simplifying Healthcare, Impacting Lives!’</Text>
          </Box>
          <br/>
          {/* <Box>
            <Text fontSize='md' color="balck">PharmEasy delivers reliable and accurate medical information that has been carefully written, vetted and validated by our health experts. Our specialists curate high-quality and most reliable literature about medicines, illnesses, lab tests, Ayurvedic and over the counter health products.</Text>
